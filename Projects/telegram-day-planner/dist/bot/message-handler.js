...
export class MessageHandler {
    ...
    async processInput(ctx, sourceType, content) {
    ...
    async getOrCreateUser(telegramId, from) {
    ...
    async createEntities(userId, inboxEntryId, result) {
        // Create projects
    ...
    async rebuildDayPlan(userId) {
        ...
        const result = await this.ai.buildDayPlan(tasks.map((t) => ({ id: t.id, title: t.title, priority: t.priority })), today);
