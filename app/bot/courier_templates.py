...
TEXT_ACK_PHASE1: Final[str] = "Принял, сохранил во входящие."

HELP: Final[str] = (
    "Привет! Я помогу собрать мысли в порядок.\n"
    "Просто пиши или говори — я разложу на задачи и заметки.\n\n"
    "Команды:\n"
...
NOT_ONBOARDED: Final[str] = "Похоже, мы ещё не знакомы. Нажми /start — настроим всё за минутку :)"
