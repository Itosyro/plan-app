...
> **СТАТУС (2026-05-26):** D ✅ (#123), A ✅ (#124 канбан=категории + DnD),
> C ✅ (#126/#127 completed_at + «Выполненные» + linger), E2 ✅ (#125 Настройки
> Mira), E-дизайн ✅ частично (#128/#129 aurora-фон + навбар Mira + `DESIGN.md`),
> F1 ✅ (#131 поповер «Раскладка»), B ✅ (#132 календарь Месяц/Неделя/Агенда +
> цвета категорий). **Сейчас:** G1 (prompt-injection: XML-делимитеры на всех
> LLM-стадиях + Security-секции в промптах + тесты) + G6 (SECURITY.md). Дальше:
> G2 (pin actions/docker по SHA), G3 (подтверждение delete), G4 (security
> headers), доделка E (чек-анимация), F2 (группировка/сортировка/фильтр).
