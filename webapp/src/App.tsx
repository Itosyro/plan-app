    ...
    >
      ...
      >
        <Header
          ...
          onOpenBoards={
            // Kept in Notes only — adding it to Tasks made the header
            // cluttered for the home screen (4 icons + the create FAB).
            // Discovery via Notes is fine; if it ever becomes a primary
            // surface we can promote it back.
            activeTab === "notes"
              ? () => {
                  haptic("select");
                  navigate("/boards");
